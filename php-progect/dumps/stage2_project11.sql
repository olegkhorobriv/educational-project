...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 31 2020 г., 11:03
...
INSERT INTO `category` (`id`, `url`, `title`, `desctipion`) VALUES
(1, 'garri-potter', 'Гарри Поттер', 'Все шутки о сабже'),
(2, 'angry', 'Бесят', 'Шутки о том што все бесят');
